...
class LedgerScreen extends StatelessWidget {
  ...
  void _showSettleUpConfirmation(
    ...
    final message = isOwed
        ? 'Mark as settled with ${user.name}?\nThey owe you ${currencyFormat.format(balance)}'
        : 'Mark as settled with ${user.name}?\nYou owe them ${currencyFormat.format(balance.abs())}';
          ...
          FilledButton(
            onPressed: () {
              ...
              dialogContext.read<LedgerBloc>().add(
                LedgerSettleUp(user: user, squadId: squadId),
              );
              ...
              state.expenses.isEmpty
                  ? SliverToBoxAdapter(
                      child: EmptyState(
                        ...
                        onActionPressed: () =>
                            LedgerScreen.showAddExpenseModal(context, squadId),
